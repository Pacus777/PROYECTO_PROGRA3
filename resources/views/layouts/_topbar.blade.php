<header class="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-slate-100 bg-white/80 px-6 backdrop-blur-md">
    <div class="flex min-w-0 items-center gap-3">
        ...
        <button
            type="button"
            class="hidden rounded-xl p-2 text-slate-600 transition hover:bg-indigo-50 hover:text-indigo-600 lg:inline-flex"
            @click="sidebarOpen = !sidebarOpen"
        >
            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 12h16M10 6l-6 6 6 6"/>
            </svg>
        </button>
    ...
    <div class="flex items-center gap-3">
        <label class="relative hidden items-center md:flex">
            <svg class="pointer-events-none absolute left-3 h-4 w-4 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-4.35-4.35M10.5 18a7.5 7.5 0 100-15 7.5 7.5 0 000 15z"/>
            </svg>
            <input
                type="text"
                placeholder="Buscar..."
                class="w-48 rounded-xl bg-slate-100 py-2 pl-9 pr-4 text-sm text-slate-700 transition-all placeholder:text-slate-400 focus:w-64 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-300"
            >
        </label>

        <button type="button" class="relative rounded-xl p-2 text-slate-500 transition hover:bg-slate-100">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <span class="pulse-soft absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-red-500"></span>
        </button>

        <button type="button" class="rounded-xl p-2 text-slate-500 transition hover:bg-slate-100">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            >
                <div class="bg-indigo-50 px-4 py-3">
                    ...
                    <p class="truncate text-xs text-indigo-500">{{ $dashboardUser->correo_usu ?? 'sin-correo@demo.com' }}</p>
                </div>

                <div class="border-t border-slate-100 p-2">
                    <a href="#" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-600 transition hover:bg-indigo-50 hover:text-indigo-700">
                    ...
                    <a href="#" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-600 transition hover:bg-indigo-50 hover:text-indigo-700">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317a1 1 0 011.35-.936l1.296.518a1 1 0 00.758 0l1.296-.518a1 1 0 011.35.936l.117 1.379a1 1 0 00.516.804l1.184.658a1 1 0 01.432 1.328l-.56 1.266a1 1 0 000 .804l.56 1.266a1 1 0 01-.432 1.328l-1.184.658a1 1 0 00-.516.804l-.117 1.379a1 1 0 01-1.35.936l-1.296-.518a1 1 0 00-.758 0l-1.296.518a1 1 0 01-1.35-.936l-.117-1.379a1 1 0 00-.516-.804l-1.184-.658a1 1 0 01-.432-1.328l.56-1.266a1 1 0 000-.804l-.56-1.266a1 1 0 01.432-1.328l1.184-.658a1 1 0 00.516-.804l.117-1.379z"/></svg>
                        Configuración
                    </a>
                </div>

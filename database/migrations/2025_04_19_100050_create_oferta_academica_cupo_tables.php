...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('oferta_academica', function (Blueprint $table) {
            ...
            $table->foreign('id_ges_oac')->references('id_ges')->on('gestion')->cascadeOnDelete();
            $table->foreign('id_ued_oac')->references('id_ued')->on('unidad_educativa')->cascadeOnDelete();
            $table->foreign('id_niv_oac')->references('id_niv')->on('nivel')->cascadeOnDelete();
            $table->foreign('id_cur_oac')->references('id_cur')->on('curso')->cascadeOnDelete();
            $table->foreign('id_par_oac')->references('id_par')->on('paralelo')->cascadeOnDelete();
            $table->unique(
        ...
        Schema::create('cupo', function (Blueprint $table) {
            ...
            $table->foreign('id_oac_cup')->references('id_oac')->on('oferta_academica')->cascadeOnDelete();
        });
    }
